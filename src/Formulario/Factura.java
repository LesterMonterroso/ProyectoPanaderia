...
public class Factura extends javax.swing.JInternalFrame {
    ...
    void factura(){
       String InsertarSQL="INSERT INTO factura (num_fac,cod_cli,Nit_cli,subtotal,IVA,total,fec_fac) VALUES (?,?,?,?,?,?,?)";
    ...
    try {
            ...
            if(n>0)
            {
                JOptionPane.showMessageDialog(null,"La Transaccion se Realizo correctamente");
            }
    ...
    private void initComponents() {
        ...
        txtnomape.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 153)));
        ...
        btnclientes.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/search_find_client_user_16693.png"))); // NOI18N
        btnclientes.setText("...");
        ...
        txtruc.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 153)));
        ...
        txtfec.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 153)));
        ...
        jLabel6.setText("NIT 10046495581");

        jLabel17.setText("Nº");

        txtfac.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 153)));
        ...
        txtsubtotal.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 153)));

        jLabel19.setText("IVA:");

        txtiva.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 153)));

        jLabel20.setText("Total:");

        txttotal.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 153)));
...
// TODO add your handling code here:
    ...
    ventanaadmin.jpeventos.add(cli);
     cli.toFront();
    cli.setVisible(true);
...
// TODO add your handling code here:
    ...
    ventanaadmin.jpeventos.add(pro);
    pro.toFront();
    pro.setVisible(true);
