...
public class clientes extends javax.swing.JInternalFrame {
    ...
    void mostrarclientes(String valor)
    {
        ...
        String Sql="SELECT * FROM cliente WHERE CONCAT(cod_cli,nom_cli,ape_cli,dpi_cli) LIKE '%"+valor+"%'";
    ...
    private void initComponents() {
        ...
        btnbus.setBackground(new java.awt.Color(0, 153, 153));
        ...
        txtbus.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 153)));
...
// TODO add your handling code here:
    String cod="",nom="",ape="",dpi="",dir="",nit="";
    ...
    try {
        ...
        else
        {
         ...
         dpi =  (String)tbclientes.getValueAt(fila, 4);
         nit =  (String)tbclientes.getValueAt(fila, 6);
         ...
         Factura.txtdni.setText(dpi);
         Factura.txtruc.setDisabledTextColor(Color.blue);
         Factura.txtruc.setText(nit);
         this.dispose();
...
// TODO add your handling code here:
    try {
        ...
        ventanaadmin.jpeventos.add(ingcli);
        ingcli.toFront();
